...
public interface DiarySearchRepository extends RedisDocumentRepository<DiarySearchDocument, String> {

    Page<DiarySearchDocument> findByVisibilityAndTitleContainingOrVisibilityAndContentContaining(
            String visibility1,
            String title,
            String visibility2,
            String content,
