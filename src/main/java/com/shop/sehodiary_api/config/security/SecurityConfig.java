    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(a->
                        a
                                .requestMatchers(HttpMethod.GET, "/user/entrypoint/**", "/user/access-denied/**", "/user/test2/**", "/comment/diary/**", "/diary/public/**", "/diary/all/**", "/diary/one/**", "/diary/public/search/**", "/like/nicknames/**", "/emotion/all/**", "/sse/posts/**", "/api/push/public-key/**", "/rss.xml").permitAll()
